      ...
      child: AnimatedContainer(
        ...
        child: Column(
          children: <Widget>[
                  ...
                  Padding(
                    ...
                    InkWell(
                      onTap:()=>setState(() {
                        ...
                        Navigator.of(context).pushReplacement(MaterialPageRoute(builder: (context)=> FirstPage(uid,uname)));
                      })
                      ,
                      child: Text(
                      'See All',
            ...
            Expanded(
              child: FutureBuilder(
                future: Firestore.instance.collection("Transactions").document(uid).collection(uname).getDocuments(),
                  ...
                  if (snapshot.connectionState == ConnectionState.done && snapshot.hasData){
                    return LiquidPullToRefresh(
                      ...
                      DocumentSnapshot data = snapshot.data.documents[i];
                        ...
                        return TransactionItem(title: data["Transaction_Name"].toString(),value: data["Amount"].toString(),category: data["Category"].toString(),);
                      },
                  ),
                    );}
