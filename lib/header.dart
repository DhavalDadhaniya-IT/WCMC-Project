  ...
  static List<charts.Series<Expense, String>> _series = [
    charts.Series<Expense, String>(
      ...
      data: [
        ...
        Expense('Fuel', 69.54, Color(0xfffe91ca)),
        Expense('Food', 30, Color(0xfff6d743)),
        Expense('Stationery', 22.99, Color(0xfff57b51)),
      ],
    )
  ];
          ...
          children: <Widget>[
            ...
            Row(
              ...
              children: <Widget>[
                ...
                FlatButton(
                  onPressed:  (){  Navigator.of(context).pushReplacement(MaterialPageRoute(builder: (context) => CalculatorWidget()));},
                  color: Colors.white,
                  shape: RoundedRectangleBorder(
                    borderRadius: BorderRadius.circular(24),
                  ),
