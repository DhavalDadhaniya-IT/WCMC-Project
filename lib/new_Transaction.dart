...
String uid;
String uname;
   TextEditingController trans_name = new TextEditingController(text: 'Transaction Name');
   TextEditingController amount = new TextEditingController(text: '2000');
   TextEditingController category = new TextEditingController(text: 'Electricity');
...
//FirebaseUser user;
  ...
  onChangeDropdownItem(Category selectedCompany) {
   ...
   updateData(String tname, String date,String amount,String category,String uname ) async {
     ...
     else{this.uname=user.uid;}

     final CollectionReference vaultCollection = Firestore.instance.collection('Transactions').document(uid).collection(user.displayName);
              ...
              Row(
                ...
                children: <Widget>[
                  ...
                  RaisedButton.icon(
                      ...
                      onPressed:()=>updateData(trans_name.text,selectedDate.toString(),amount.text,category.text,uname),
                      icon: const Icon(
                        Icons.add,
                        color: Colors.white,
                      ),
